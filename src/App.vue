<template>
  <div id="app">
            ...
            <div  id="navbarNavDropdown" class="navbar-collapse collapse">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown dropdown-full-width">
                     ...
                     <li class="nav-item dropdown dropdown-full-width">
                        <a class="nav-link" href="/#/signup" aria-haspopup="true" aria-expanded="false">
                            Signup  
                        </a>
                    </li>
                     <li class="nav-item dropdown dropdown-full-width">
                        <a class="nav-link" href="/#/logout" aria-haspopup="true" aria-expanded="false">
                            Logout  
                        </a>
                    </li>
            ...
            <ul>  
                ...
                <li data-index="rs-3047" data-transition="parallaxtoright" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0"  data-saveperformance="off"  data-title="HTML5 Video" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                    ...
                    <div class="tp-caption mainSlide-Title-Centered   tp-resizeme" 
                         ...
                         style="z-index: 6; text-align:center; white-space: normal;">Shared Expenses </div>
                    <!-- LAYER NR. 3 -->
                    <div class="tp-caption mainSlide-caption   tp-resizeme" 
                         ...
                         data-paddingbottom="[10,10,10,10]"
                         data-paddingleft="[0,0,0,0]"
                         style="z-index: 6; text-align:left; max-width:1170px; white-space: normal;">Easily share your expenses with your friends and loved ones!</div>
                </li>
            </ul>
    ...
    <div class="container pt90"><router-view /></div>
    ...
    <div class="footer-bottomAlt">
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-5"><span>&copy; Copyright 2018. All Right Reserved</span></div>
        </div>
      </div>
    </div>
    <!-- /footer bottom -->
